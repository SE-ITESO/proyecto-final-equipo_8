...
#ifndef BITS_H_ // Compilación condicional lo va a procesar el preprocesador
#define BITS_H_ // son condicionales especializadas para comprobar si un macro-identificador está definido o no
...
typedef enum {DISABLED, ENABLED} enable_t;
